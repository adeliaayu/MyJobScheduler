package com.dicoding.kotlin.myjobscheduler
...
class GetCurrentWeatherJobService : JobService() {
    ...
    private fun showNotification(context: Context, title: String, message: String, notifId: Int) {
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setSmallIcon(R.drawable.ic_replay_30_black_24)
    ...
    companion object {
        ...
        internal const val CITY = "Malang"

        // API Key openweathermap
        internal const val APP_ID = "674208b570fc244929d1b0a0f2bbe484"
    }
}